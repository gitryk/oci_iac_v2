...
resource "oci_core_internet_gateway" "this" {
  ...
  display_name = "${var.project_name}-oci-igw"

  freeform_tags = merge(var.tagging, {
    "Name" = "${var.project_name}-oci-igw"
    "Type" = "Network"
  })
...
resource "oci_core_nat_gateway" "this" {
  ...
  display_name = "${var.project_name}-oci-nat"

  freeform_tags = merge(var.tagging, {
    "Name" = "${var.project_name}-oci-nat"
    "Type" = "Network"
  })
...
resource "oci_core_security_list" "this" {
  ...
  display_name = "${var.project_name}-oci-seculist"
  ...
  freeform_tags = merge(var.tagging, {
    "Name" = "${var.project_name}-oci-seculist"
    "Type" = "Network"
  })
...
resource "oci_core_subnet" "this" {
  ...
  #Optional
  display_name = "${var.project_name}-oci-sub-${each.key}"
  ...
  freeform_tags = merge(var.tagging, {
    "Name" = "${var.project_name}-oci-sub-${each.key}"
    "Type" = "Network"
  })
...
resource "oci_core_route_table" "pub_route" {
  ...
  display_name = "${var.project_name}-oci-route-pub"
  route_rules {
  ...
  freeform_tags = merge(var.tagging, {
    "Name" = "${var.project_name}-oci-route-pub"
    "Type" = "Network"
  })
...
resource "oci_core_network_security_group" "this" {
  ...
  display_name = "${var.project_name}-oci-nsg-${each.key}"

  freeform_tags = merge(var.tagging, {
    "Name" = "${var.project_name}-oci-nsg-${each.key}"
    "Type" = "Network"
  })
